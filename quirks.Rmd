...
This chapter is a reference, for when you know the right tool for the job, but don't know where it is in R; or for when you have a tool, but it behaves less like a hammer than a nailgun shooting you in the foot. 

The major quirks were covered in \@ref(basics)'s <span class="spnote" id="quirk-dummy"></span>s. What's left is mostly thanks to R's lack of a consistent naming pattern for functions.
