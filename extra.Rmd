...
Some more, just dropping this here...

**Other resources:** 

* Emphasize that internal resources are best. Can recap:
  * Task Views
  * ?, ??
  * Manuals
  * vignettes
  * point again to section on browsing function code
  * etc
* Repos: CRAN, Bioconductor, Github, skip old and new obscure ones (gitlab, omegahat, bitbucket)
* Maybe datacamp's intro to r (try it first).  But nope to: O'Reilly codeschool, Jupyter. Caveat about links breaking, recommendation to search online for latest.
* Can also cover how to ask on SO. 

----

**UI features.** 

* Arrow keys, HOME/END for navigating console. 
* Drag and drop into the console. 
* Management of windows. Can cut down on some of the platform comparisons in the first chapter.

----

**Updating R.**

I'd say just install it all again.

---- 

**Debugging, package development, testing.**

I don't actually know how to do this competently.
