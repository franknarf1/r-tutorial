...
This adds all of the package's functions and other objects to the search path, so you can write `fortune(111)` instead of the more verbose `fortunes::fortune(111)`. The downside to attaching a package is the risk of "namespace conflicts": 
...
todo -- explain the syntax, starting with function() ending with (possibly implicit) return()
