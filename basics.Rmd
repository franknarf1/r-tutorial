...
Many such hidden functions are "methods," discussed further in \@ref(methods). There are also several functions that *should* be hidden, documented at `?.subset`. Don't use any hidden functions directly.
